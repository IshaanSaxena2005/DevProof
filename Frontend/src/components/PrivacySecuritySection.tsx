  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
        ...
        >
          <GlassPanel hover={false} className="p-3 md:p-4 flex flex-col gap-2.5 shadow-2xl">
            {HIGHLIGHTS.map((item, idx) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ x: 4 }}
                  className="glass-inset flex items-center gap-3 p-3 hover:border-white/18 hover:bg-white/[0.05] transition-all duration-300 group cursor-default"
                >
                  <div
