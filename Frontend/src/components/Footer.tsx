export default function Footer() {
  return (
    <footer className="relative w-full border-t border-white/[0.08] py-12 md:py-16 section-veil-strong">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8 mb-14">
          <div className="md:col-span-2 flex flex-col gap-4">
            ...
            <p className="text-sm font-light max-w-xs leading-relaxed" style={{ color: "var(--text-secondary)" }}>
              Developer Intelligence &amp; Growth Analytics
            </p>
          </div>
        ...
        <div className="pt-8 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-3">
